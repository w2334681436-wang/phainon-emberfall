...
export default function Game() {
  ...
  useEffect(() => {
    ...
    let minionKills = 0,
      ...
      bossDefeated = false;
    const bg = new Image();
    bg.src = "/assets/hell-battlefield.png";
    const heroNormal = new Image();
    heroNormal.src = "/assets/phainon-normal-v3.png";
    const heroGod = new Image();
    heroGod.src = "/assets/phainon-god-v3.png";
    const heroJump = new Image();
    heroJump.src = "/assets/phainon-jump-v4.png";
    ...
    foes.src = "/assets/enemy-sprites-v2.png";
    const vfx = new Image();
    vfx.src = "/assets/combat-vfx-v3.png";
    const bossSheet = new Image();
    bossSheet.src = "/assets/fenfeng-boss-v6.png";
    const whiteHole = new Image();
    whiteHole.src = "/assets/white-hole-battlefield-v4.png";
